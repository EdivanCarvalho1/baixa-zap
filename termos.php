...
<body>
    <div>
        ...
        <main>
            <h2><span style="color: #002D62;">1. Termos</span></h2>
            <p><span style="color: rgb(68, 68, 68);">Ao acessar ao site <a href="https://baixarzap.com.br/">Baixar
                        Zap</a>, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis
                    ​​e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não
                    concordar com algum desses termos, está proibido de usar ou acessar este site. Os materiais contidos
                    neste site são protegidos pelas leis de direitos autorais e marcas comerciais aplicáveis.</span></p>
            <h2><span style="color: #002D62;">2. Uso de Licença</span></h2>
            <p><span style="color: rgb(68, 68, 68);">É concedida permissão para baixar temporariamente uma cópia dos
                    materiais (informações ou software) no site Baixar Zap , apenas para visualização transitória
            ...
            <ol>
                ...
                <li><span style="color: rgb(68, 68, 68);">tentar descompilar ou fazer engenharia reversa de qualquer
                        software contido no site Baixar Zap;&nbsp;</span></li>
            ...
            <p><span style="color: rgb(68, 68, 68);">Esta licença será automaticamente rescindida se você violar alguma
                    dessas restrições e poderá ser rescindida por Baixar Zap a qualquer momento. Ao encerrar a
            ...
            <h2><span style="color: #002D62;">3. Isenção de responsabilidade</span></h2>
            <ol>
                <li><span style="color: rgb(68, 68, 68);">Os materiais no site da Baixar Zap são fornecidos 'como
                        estão'. Baixar Zap não oferece garantias, expressas ou implícitas, e, por este meio, isenta e
                ...
                <li><span style="color: rgb(68, 68, 68);">Além disso, o Baixar Zap não garante ou faz qualquer
            ...
            <h2><span style="color: #002D62;">4. Limitações</span></h2>
            <p><span style="color: rgb(68, 68, 68);">Em nenhum caso o Baixar Zap ou seus fornecedores serão responsáveis
                    ​​por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a
                    interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os materiais em Baixar Zap,
                    mesmo que Baixar Zap ou um representante autorizado da Baixar Zap tenha sido notificado oralmente ou
            ...
            <h2><span style="color: #002D62;">5. Precisão dos materiais</span></h2>
            <p><span style="color: rgb(68, 68, 68);">Os materiais exibidos no site da Baixar Zap podem incluir erros
                    técnicos, tipográficos ou fotográficos. Baixar Zap não garante que qualquer material em seu site
                    seja preciso, completo ou atual. Baixar Zap pode fazer alterações nos materiais contidos em seu site
                    a qualquer momento, sem aviso prévio. No entanto, Baixar Zap não se compromete a atualizar os
                    materiais.</span></p>
            <h2><span style="color: #002D62;">6. Links</span></h2>
            <p><span style="color: rgb(68, 68, 68);">O Baixar Zap não analisou todos os sites vinculados ao seu site e
                    não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica
                    endosso por Baixar Zap do site. O uso de qualquer site vinculado é por conta e risco do
                    usuário.</span></p>
            <p><br></p>
            <h3><span style="color: #002D62;">Modificações</span></h3>
            <p><span style="color: rgb(68, 68, 68);">O Baixar Zap pode revisar estes termos de serviço do site a
            ...
            <h3><span style="color: #002D62;">Lei aplicável</span></h3>
            <p><span style="color: rgb(68, 68, 68);">Estes termos e condições são regidos e interpretados de acordo com
                    as leis do Baixar Zap e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais
